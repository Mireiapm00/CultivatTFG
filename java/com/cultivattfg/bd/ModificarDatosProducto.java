 ...
 * @author mireia
 */
public class ModificarDatosProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(con.modificarProductoBD(producto)){
            sesion.setAttribute("SUCCESS", "Dades del producte actualitzades");
            
            response.sendRedirect("./userAccess_component/mod_productos.jsp");
        }
        else {
            sesion.setAttribute("ERROR", "Error al actualitzar el producte");
