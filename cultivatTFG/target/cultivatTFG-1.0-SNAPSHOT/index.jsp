...
<html>
    <head>
        ...
        <link rel="icon" type="image/ico" href="./img/logos/logo-web-icon.png" sizes="64x64">
        ...
        <nav class="navbar navbar-expand-xl sticky-top navbar-light">
            <div class="container-md">
                <a id="noborder" class="navbar-brand" href="#">
                    <img src="img/logos/logo-web-nav-300x55.png" onclick="Cargar('home_component/home.html', 'cuerpo')" alt="Inici">
                </a>
