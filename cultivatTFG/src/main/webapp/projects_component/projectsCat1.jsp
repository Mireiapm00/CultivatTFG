<%-- 
    Document   : projectsCat1
    Created on : 22-jul-2021, 13:20:05
    Author     : mireia
--%>
...
<html>
    ...
    <body>
        <%
            ...
            List<ProductoresBD> productores = con.obtenerProductoresPorCategoria(2);
        %>
        <div class="container">
    ...
    %>
                <div>
                    <div class="card mx-4 mt-4" style="width: 15rem;">
                        <img src="<%=prod.getImgroute()%>" class="card-img" alt="Detall productor">
